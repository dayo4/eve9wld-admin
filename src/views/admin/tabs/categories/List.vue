<template>
  <article class="Tab xs12">
    <h2 class="text-center t-blue-grey--1">All Categories</h2>
    ...
    >
      <div class="xs11 sm6">
        <div class="text-center br2 m-6">
          <h3 class="bg-green p-4">Add New Category</h3>
          <p class="icon-check t-green m-4"></p>
        </div>
      </div>
      <div class="xs11 sm6">
        <div class="text-center br2 m-6">
          <h3 class="bg-light-blue p-4"></h3>
      ...
      <table class="DtTable">
        ...
        <tbody>
          <tr>
            ...
            <td>
              Hairdresser Hairdresser Hairdresser Hairdresser Hairdresser
              Hairdresser
            </td>
            <td>12/09</td>
            <td>Great idea</td>
