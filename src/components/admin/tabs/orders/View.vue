    ...
    <article class="Tab xs12">
        ...
        <section>
            <table class="DtTable">
				...
				<section>
						<h3 class="icon-edit p-3 bg-blue-grey-4 t-blue-grey">billing details(23)</h3>
				</section>
				<section>
						...
						<table class="m-3 p-3">
							...
							<td class="t-blue-grey p-1 text-center m-1">Oct 23, thur 2021</td>
							<td class="t-light-blue p-1 m-1">Support</td>
							<td class="icon-alert-danger t-green p-1 m-1">Missing payment details. Email was sent and awaiting for payment before processing</td>
						</tr>
						<!-- ... -->
						</tbody>
						</table>
