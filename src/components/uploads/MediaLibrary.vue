...
<article v-show="show === true" class="LibModal">
    ...
    <section class="Head">
			<div class="flex wrap a-i-center">
				...
				<button @click="triggerImageEditor" class="btn bg-cyan font-6 my-3 p-3 b4">Upload New Image</button>
			</div>
        <section class="DtCtrlBox">
            <div class="Divi">
                ...
                <section class="flex a-i-center">
                    <input class="Search" type="search" name="searchProducts" placeholder="search" />
                    <button class="icon-search-2 btn bg-white py-2 t-grey shadow-0"></button>
                </section>
            </div>
        ...
        <section class="GridView flex wrap m-3">
			...
			<div class="xs12 sm4 md3 lg2">
				...
				<section>
					...
					<button @click="copyUrl" class="btn bg-white t-blue p-3" name="copyUrl">Copy Url</button>
				</section>
			</div>
    </section>
...
<i @click="$emit('closed')" class="LibModalClose icon-cancel shadow-3"></i><!-- absolute positioned close button for the modal -->
<!-- Image Library Close Button -->
