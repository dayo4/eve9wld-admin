...
<div>
    <section>
        <!-- Header Section -->
        <h3 class="Head flex a-i-center j-c-between shadow-1 bg-pink-1 t-white font-7 p-2 noselect br2">
        ...
        <div class="Body t-blue-grey">
            <img :src="$userBaseUrl + user.profile_image" :alt="user.username" class="mr-6" width="150" height="150" />
    ...
    <section class="flex wrap">
        ...
        <article class="xs11 lg6 pr-2">
            ...
            <section>
                <h3 class="icon-edit p-3 bg-blue-grey-4 t-blue-grey">User quick Stats</h3>
                <div>
        ...
        <article class="xs11 lg6 pl-2">
            ...
            <section>
                <h3 class="icon-edit p-3 bg-blue-grey-4 t-blue-grey">Products in cart (23)</h3>
                <!-- Create a table here [items, price, status, date ]-->
            </section>
            <section>
                <h3 class="icon-edit p-3 bg-blue-grey-4 t-blue-grey">Customer Addresses/billing details(23)</h3>
            </section>
            <!-- Add other stuffs -->
        </article>
    </section>
    ...
    <article>
        <section class="History">
            <h3 class="icon-user p-3 bg-blue-grey-4 t-blue-grey">User's Account Status History</h3>
        ...
        <section class="History">
            <h3 class="icon-user p-3 bg-blue-grey-4 t-blue-grey">Admin Private Notes</h3>
            <div>
...
export default defineComponent({
    components: {
        AccStatusUpdate,
        Dropdown: () =>
            import ('@/components/GlobalComponents/utils/Dropdown.vue'),
    },
    data() {
        return {
