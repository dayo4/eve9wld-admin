        ...
        <section class="AltBoxCont xs12 md4">
            ...
            <div class="Images">
                <section>
                    ...
                    <button @click="showMedLib = true" class="btn m-2 p-2">
...
export default defineComponent({
    components: {
        // MediaLibrary,
        Composer: defineAsyncComponent(() => import("@/components/Editor/TextEditor.vue")),
        MediaLibrary: defineAsyncComponent(() => import("@/components/uploads/MediaLibrary.vue")),
    },
    data() {
        return {
            showMedLib: false,
    ...
    methods: {
        ...
        triggerImageTransformer() {
            ;(this.$refs.imageTransformer as any) /* child component */
                .trigger()
        },
        ...
        startProcessing() {
            ;(this.$refs.composer as any) /* child component */
                .init()
        },
    },
})
